...
#define B0_I (+14.7141240913872020)
#define B1_I (+0.1500313019641205)
#define B2_I (-14.5640927894230800)
...
#define STRING_ILOOP_FX		"ILOOP FX: 99KHZ"
#define STRING_ILOOP_PM		"ILOOP GM: 99DEG"
#define STRING_ILOOP_GM		"ILOOP PM: 99DB"
